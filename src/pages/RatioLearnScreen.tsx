...
export default function RatioLearnScreen() {
  const navigate = useNavigate();
  return (
    <PageTransition>
      <div className="min-h-screen pb-28 bg-background">
        <div className="pt-12">
          <PageHeader hero="RATIO" subtitle="Concepts, formulas and shortcuts for ratio problems." />
        </div>
        <div className="px-6 mt-6">
          <PressableCard className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-2">Ratio concept content will be added here.</p>
          </PressableCard>
          <motion.button
            whileTap={{ scale: 0.96 }}
            onClick={() => navigate(-1)}
