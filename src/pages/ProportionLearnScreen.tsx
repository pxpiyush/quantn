...
export default function ProportionLearnScreen() {
  const navigate = useNavigate();
  return (
    <PageTransition>
      <div className="min-h-screen pb-28 bg-background">
        <div className="pt-12">
          <PageHeader hero="PROPORTION" subtitle="Concepts, formulas and shortcuts for proportion problems." />
        </div>
        <div className="px-6 mt-6">
          <PressableCard className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-xs text-muted-foreground mt-2">Proportion concept content will be added here.</p>
          </PressableCard>
          <motion.button
            whileTap={{ scale: 0.96 }}
            onClick={() => navigate(-1)}
