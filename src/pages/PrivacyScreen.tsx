...
const sections = [
  {
    ...
    points: [
      { icon: FileText, title: "Free to Use", desc: "REAZN is completely free. You may use it for personal, non-commercial exam preparation purposes." },
      { icon: Scale, title: "Content Ownership", desc: "All questions, explanations, and content on REAZN are original or curated by us. Reproduction, redistribution, or scraping of content is not permitted." },
  ...
  },
  {
    ...
    points: [
      ...
      { icon: Cookie, title: "No Cookies", desc: "REAZN doesn't use cookies of any kind — no session cookies, no advertising cookies, nothing." },
    ],
  },
  {
    heading: "In Simple Words",
    points: [
      { icon: Heart, title: "Built for You, Not Your Data", desc: "REAZN was made to help you learn reasoning — that's it. We don't run ads and we don't sell data. Your privacy is not a feature, it's a promise." },
    ],
  },
];
    ...
    <PageTransition>
      <div className="min-h-screen bg-background px-5 pt-14 pb-10">
        ...
        <p className="text-xs text-muted-foreground leading-relaxed mb-8">
          Simple, honest, and jargon-free. Here's how REAZN works and what we promise.
        </p>
